...
def run_demo(
    device_idx=0,
    ckpt="/home/rliu/Desktop/cvfiler04/ruoshi/github/sjc/stable-diffusion/models/ldm/stable-diffusion-v1/sd-clip-vit-l14-img-embed_ema_only.ckpt",
    config="configs/stable-diffusion/sd-objaverse-finetune.yaml",
    ):
