...
from voxnerf.data import load_googlescan_data
...
class SJC(BaseConf):
    ...
    nerf_path:        str = "/home/rliu/Desktop/cvfiler04/datasets/GoogleScannedObjects"
...
def sjc_3d(poser, vox, model: ScoreAdapter,
    ...
    input_image, input_pose, input_mask, input_mesh_path = load_googlescan_data(nerf_path, scene, index)
